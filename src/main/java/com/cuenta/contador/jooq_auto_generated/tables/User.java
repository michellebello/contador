...
public class User extends TableImpl<UserRecord> {
    ...
    /**
     * The reference instance of <code>contadordb.user</code>
     */
    ...
    /**
     * The column <code>contadordb.user.last_name</code>.
     */
    ...
    /**
     * Create an aliased <code>contadordb.user</code> table reference
     */
    ...
    /**
     * Create a <code>contadordb.user</code> table reference
     */
    public User() {
    ...
    public List<ForeignKey<UserRecord, ?>> getReferences() {
        return Arrays.asList(Keys.USER_IBFK_1);
    }
    ...
    public CredentialsPath credentials() {
        if (_credentials == null)
            _credentials = new CredentialsPath(this, Keys.USER_IBFK_1, null);
